...
export interface ChartContextValue extends ChartHoverContextValue {
  ...
  /**
   * {@link ReferenceArea} bands — drives y-axis label colors in range. Optional
   * because the locally-patched chart shells (time-series, candlestick) don't
   * populate it; reference-area bands render via their own registration context.
   */
