      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          style={{
            width: TRACK_WIDTH,
            height: TRACK_HEIGHT,
            // Off-track uses the FF overlay tint (theme-adaptive, visible on any
            // surface) rather than --accent, which is too light on surface-2 cards.
            backgroundColor: checked
              ? hovered
                ? "#5C89F2"
                : "#6B97FF"
              : hovered
                ? "rgb(var(--overlay) / 0.16)"
                : "rgb(var(--overlay) / 0.11)",
          }}
