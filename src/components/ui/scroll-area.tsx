...
>(({ className, children, viewportClassName, scrollbarClassName, orientation = "vertical", style, ...props }, ref) => {
  const isTouch = useTouchPrimary();
  const fadeClass = orientation === "horizontal" ? "scroll-fade-effect-x" : "scroll-fade-effect-y";
      ...
      {isTouch ? (
        ...
        >
          <div
            ...
            className={cn("size-full overflow-auto rounded-[inherit]", fadeClass, viewportClassName)}
            tabIndex={0}
          >
            {children}
          </div>
